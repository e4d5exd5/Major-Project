...
def createModel(IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_DEPTH, IMAGE_CHANNEL):
    ...
    output_layer_5_ele_add = layers.Add()([output_layer_5_SA_concat, output_layer_4_conv])

    output_layer_5_normalization = layers.LayerNormalization()(output_layer_5_ele_add)
